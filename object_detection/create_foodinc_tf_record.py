...
r"""Convert the Foodinc dataset to TFRecord for object_detection.
...
Example usage:
    ./create_foodinc_tf_record --data_dir=/home/user/foodinc \
...
def main(_):
  ...
  num_examples = len(trainval_list)
  num_train = int(0.7 * num_examples)
  train_examples = trainval_list[:num_train]
  val_examples = trainval_list[num_train:]
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'foodinc_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'foodinc_val.record')
